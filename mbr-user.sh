...
case $? in
    0)
         clear
         pacman -S xorg-server xf86-input-libinput xf86-video-vesa xf86-video-ati xf86-video-amdgpu xf86-video-intel xorg-xinit virtualbox-guest-utils --noconfirm
        ;;
    1)
         clear
